...
6. **複数のプロジェクトを一度に見る。** 並べ方を「担当者別」にすると、
   同じ人の作業が全プロジェクト横断で 1 本の時間軸に並ぶ（[`ui/15-multi-project.md`](ui/15-multi-project.md)）
